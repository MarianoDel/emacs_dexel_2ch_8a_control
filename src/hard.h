...
//----------- Firmware Version -------------------
#define FIRMWARE_VER_1_8    // have lbs localization
...
#ifdef FIRMWARE_VER_1_8
#define SOFT    "Firmware version 1.8\n"
#endif
...
#if (!defined FIRMWARE_VER_1_8) && \
    (!defined FIRMWARE_VER_1_7) && \
...
//GPIOA pin1	V_Sense_4V
// TEST1 input as alarm input; use on 3.3V
#define ALARM_INPUT    ((GPIOB->IDR & 0x0040) != 0)
#endif
